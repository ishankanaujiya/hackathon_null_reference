...
class DisplayCategoryDetailsForHome extends StatefulWidget {
  ...
  DisplayCategoryDetailsForHome(this.categories, this.amount, this.paymentMethod, this.date);

  @override
  State<DisplayCategoryDetailsForHome> createState() => _DisplayCategoryDetailsForHomeState();
}

class _DisplayCategoryDetailsForHomeState extends State<DisplayCategoryDetailsForHome> {
    ...
    return Scaffold(
      ...
      body: contentSelector? Container(
        ...
        child: Padding(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                subtitle: Text(
                  "${widget.date[index]},    ${widget.paymentMethod[index]}",
                  style: TextStyle(
          ...
          child: Center(child: Text("No any expenses for ${widget.categories}", style: TextStyle(
            fontSize: 20,
            fontWeight: FontWeight.bold,
            color: fontColor,
          ),))),
